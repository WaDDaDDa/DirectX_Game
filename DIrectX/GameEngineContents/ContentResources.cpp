...
void ContentResources::ContentResourcesInit()
{
	...
	{
		std::shared_ptr<GameEngineMaterial> Mat = GameEngineMaterial::Create("FadeInEffect");
		Mat->SetVertexShader("FadeEffect_VS");
		Mat->SetPixelShader("FadeInEffect_PS");
		Mat->SetDepthState("AlwaysDepth");
		Mat->SetRasterizer("EngineRasterizer");
	}

	{
		std::shared_ptr<GameEngineMaterial> Mat = GameEngineMaterial::Create("FadeOutEffect");
		Mat->SetVertexShader("FadeEffect_VS");
		Mat->SetPixelShader("FadeOutEffect_PS");
		Mat->SetDepthState("AlwaysDepth");
		Mat->SetRasterizer("EngineRasterizer");
	}
}
