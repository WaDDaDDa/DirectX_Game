...
GameUnitStatus GameUnitStatus::KnightStat =
{
    ...
    4.2f,                   //_SkillCooltime
    20.0f,                   //_UltCooltime
    std::string_view("모든 적 유닛을 일정 시간동안 도발하여 해당 \n적의 공격 대상을 자신으로 만듭니다."),
    std::string_view("일정 시간동안 아군 모두의 방어력을 자신의 \n방어력 만큼 상승시킵니다."),
    std::string_view("기사")
};
...
GameUnitStatus GameUnitStatus::ArcherStat
{
    ...
    3.0f,                   //_SkillCooltime
    25.0f,                   //_UltCooltime
    std::string_view("근접한 대상에게 화살을 발사하며 뒤로 한 발 \n물러납니다."),
...
GameUnitStatus GameUnitStatus::MonkStat
{
    ...
    std::string_view("주변 일정 범위 아군에게 무적효과가 있는 \n보호막을 부여합니다."),
    std::string_view("몽크")
};
...
GameUnitStatus GameUnitStatus::NinjaStat
{
    ...
    3.0f,                   //_SkillCooltime
    20.0f,                   //_UltCooltime
    std::string_view("적 후방으로 순간이동 하여 강한 공격을 \n가합니다."),
    std::string_view("지속적으로 체력이 소모되는 분신을 \n소환합니다."),
    std::string_view("닌자")
};
...
GameUnitStatus GameUnitStatus::PythonessStat
{
    ...
    6.5f,                   //_SkillCooltime
    24.0f ,                  //_UltCooltime
    std::string_view("아군 한명의 체력을 회복하고 해당 아군 주변의 \n범위에 피해를 주는 폭발을 생성합니다."),
    std::string_view("아군을 회복시키거나 적군을 공격하는 영혼을 \n방출하는 문을 소환합니다."),
    std::string_view("무녀")
};
...
GameUnitStatus GameUnitStatus::PyromancerStat
{
    ...
    std::string_view("주변 일정 범위에 지속적으로 공격을 가하는 \n영역을 생성합니다."),
    std::string_view("화염술사")
};
...
GameUnitStatus GameUnitStatus::PriestStat
{
    ...
    7.0f,                   //_SkillCooltime
    30.0f   ,                //_UltCooltime
    std::string_view("일반공격이 아군을 회복하며 스킬 사용시 보다 \n더 많은 회복을 합니다."),
    std::string_view("주변 일정 범위에 지속적으로 체력을 회복\n시키는 영역을 생성합니다."),
    std::string_view("성직자")
};
...
GameUnitStatus GameUnitStatus::SwordmanStat
{
    ...
    std::string_view("일직선으로 빠르게 이동하며 경로상에 \n있는 모든 적을 베어버립니다."),
    std::string_view("검사")
};
